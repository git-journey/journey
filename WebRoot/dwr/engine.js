...
/// 定制 w00164127 
var singletonXMLHttpRequest=null;
var singletonActiveXObject=null;
...
dwr.engine._sendData = function(batch) {
  ...
  if (batch.rpcType == dwr.engine.XMLHttpRequest) {
    if (window.XMLHttpRequest) {    	
    	if(typeof singletonDWR == "boolean" && singletonDWR == true)
    	{
    			if(singletonXMLHttpRequest == null)
    			{
    				singletonXMLHttpRequest = new XMLHttpRequest();
    			}    			
    			batch.req = singletonXMLHttpRequest;
    	}
    	else
    	{    			
    ...
    // IE5 for the mac claims to support window.ActiveXObject, but throws an error when it's used
    	...
    	if(typeof singletonDWR == "boolean" && singletonDWR == true)
    	{
    			if(singletonActiveXObject == null)
    			{
    				singletonActiveXObject = dwr.engine._newActiveXObject(dwr.engine._XMLHTTP);
    			}    			
    			batch.req = singletonActiveXObject;
    	}
    	else
    	{    			
